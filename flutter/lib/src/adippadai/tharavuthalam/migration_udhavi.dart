      ...
      if (entry.seyaliVagai == 'silk') {
        await pattuDb.into(pattuDb.pattuNiruvanaTharavugalTable).insert(
          PattuNiruvanaTharavugalTableCompanion.insert(
            ...
            panEn: Value(entry.panEn),
            vangiTharavugal: Value(entry.vangiTharavugal),
            oavuruTharavugal: Value(entry.oavuruTharavugal),
            upiTharavugal: Value(entry.upiTharavugal),
            pattiyalThalaippu: Value(entry.pattiyalThalaippu),
            pattiyalArikkai: Value(entry.pattiyalArikkai),
      ...
      if (entry.seyaliVagai == 'silk') {
        await pattuDb.into(pattuDb.pattuPatrucheettuTable).insert(
          PattuPatrucheettuTableCompanion.insert(
            ...
            patrucheettuEn: Value(entry.patrucheettuEn),
            finYear: Value(entry.patruNaal.year),
