...
export const en: Record<TranslationKey, string> = {
  ...
  duplicateCustomersMessage: 'Are you sure you want to create copies of the {count} selected merchant(s)?',
  saveDuplicate: 'Save',
  deleteMerchantsTitle: 'Delete Merchants?',
  deleteMerchantsMessage: 'Are you sure you want to delete {count} merchant(s)? This action cannot be undone.',
  customersDuplicatedSuccess: 'Merchants duplicated successfully',
  errorDuplicating: 'Error duplicating merchants',
