...
export default function ReceiptView({ receipt: receiptProp, profile: profileProp, onBack, onEdit }) {
  ...
  const RECEIPT_LABELS = {
    ...
    'Tamil': { hc_paymentReceipt: 'பண ரசீது', receiptNoLabel: 'ரசீது எண்:', dateLabel: 'தேதி:', receivedFromLabel: 'பெறுநர்:', paymentModeLabel: 'கட்டண முறை:', referenceNoLabel: 'குறிப்பு எண்:', againstInvoiceLabel: 'பில் எண்:', noteLabel: 'குறிப்பு:', receivedBy: 'பெற்றவர்', authorizedSignatory: 'அங்கீகரிக்கப்பட்ட கையொப்பம்', phoneLabel: 'தொலைபேசி:', mobileLabel: 'கைபேசி:' },
