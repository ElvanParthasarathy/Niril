                ...
                <div className="bill-footer-new">
                    ...
                    <div className="preview-footer-right">
                        ...
                        <div className="sign-space" style={{ position: 'relative' }}>
                            {p.signature && (
                                <img src={p.signature} alt="Signature" style={{ position: 'absolute', top: '50%', transform: 'translateY(-50%)', right: 0, maxHeight: '110px', maxWidth: '240px', objectFit: 'contain', pointerEvents: 'none' }} />
                            )}
                        </div>
