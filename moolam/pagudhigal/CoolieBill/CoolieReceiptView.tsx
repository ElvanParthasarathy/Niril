              ...
              <div className="receipt-footer">
                <div className="preview-footer-right">
                  ...
                  <div className="sign-space" style={{ position: 'relative' }}>
                    {profile?.signature && (
                        <img src={profile.signature} alt="Signature" style={{ position: 'absolute', top: '65%', transform: 'translateY(-50%)', right: '-10px', maxHeight: '95px', maxWidth: '200px', objectFit: 'contain', pointerEvents: 'none' }} />
                    )}
                  </div>
