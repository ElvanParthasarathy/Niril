...
export default function CoolieDashboard({ onViewAll, onNew, onView, onSwitchModeRequest }: any) {
  ...
  const customSparkle = (
    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#FFC107" style={{ verticalAlign: 'text-bottom', marginLeft: '4px' }}>
      <path d="M0 0h24v24H0z" fill="none"/>
      <path d="M19 9l1.25-2.75L23 5l-2.75-1.25L19 1l-1.25 2.75L15 5l2.75 1.25L19 9zm-7.5.5L9 4 6.5 9.5 1 12l5.5 2.5L9 20l2.5-5.5L17 12l-5.5-2.5zM19 15l-1.25 2.75L15 19l2.75 1.25L19 23l1.25-2.75L23 19l-2.75-1.25L19 15z"/>
    </svg>
  );

  const greetingTitle = language === 'ta' ? <>வணக்கம்! {customSparkle}</> : <>Vanakkam! {customSparkle}</>;
