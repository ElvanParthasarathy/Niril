@echo off
title Elvan Niril Updater
cd /d "%~dp0"

echo.
echo  ========================================================
echo.
echo     Elvan Niril Updater
echo.
...
if exist "data" xcopy /E /I /Q /Y "data" "%TEMP%\elvanniril_backup\data" >nul 2>nul
if exist "Saved Invoices" xcopy /E /I /Q /Y "Saved Invoices" "%TEMP%\elvanniril_backup\Saved Invoices" >nul 2>nul
if exist "Trash" xcopy /E /I /Q /Y "Trash" "%TEMP%\elvanniril_backup\Trash" >nul 2>nul
if exist "screenshot.png" copy /Y "screenshot.png" "%TEMP%\elvanniril_backup\screenshot.png" >nul 2>nul
echo         Data backed up safely

:: Download latest code
echo  Downloading latest version...
set "ZIP_URL=https://github.com/ElvanParthasarathy/Niril/archive/refs/heads/main.zip"
set "ZIP_PATH=%TEMP%\elvanniril_latest.zip"
set "EXTRACT_PATH=%TEMP%\elvanniril_extract"
...
:: Find the extracted folder (usually elvanniril-main)
...
if exist "%TEMP%\elvanniril_backup\data" xcopy /E /I /Q /Y "%TEMP%\elvanniril_backup\data" "data" >nul 2>nul
if exist "%TEMP%\elvanniril_backup\Saved Invoices" xcopy /E /I /Q /Y "%TEMP%\elvanniril_backup\Saved Invoices" "Saved Invoices" >nul 2>nul
if exist "%TEMP%\elvanniril_backup\Trash" xcopy /E /I /Q /Y "%TEMP%\elvanniril_backup\Trash" "Trash" >nul 2>nul
if exist "%TEMP%\elvanniril_backup\screenshot.png" copy /Y "%TEMP%\elvanniril_backup\screenshot.png" "screenshot.png" >nul 2>nul
...
rmdir /s /q "%TEMP%\elvanniril_backup" 2>nul
